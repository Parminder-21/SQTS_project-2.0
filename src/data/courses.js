...
export const CATEGORY_META = {
  'Programming':          { icon: 'terminal', color: '#3B82F6', desc: 'C, C++, Java, Python and more' },
  'Web Development':      { icon: 'globe', color: '#06B6D4', desc: 'MERN, WordPress, Shopify, HTML/CSS' },
  'AI & Future Tech':     { icon: 'bot', color: '#8B5CF6', desc: 'AI Tools, Data Analysis, Cyber Security, AWS' },
  'Design & Digital Skills': { icon: 'palette', color: '#EC4899', desc: 'Graphic Design, Canva, Photoshop, Video' },
  'School Coaching':      { icon: 'school', color: '#10B981', desc: 'Computer basics for Class 3–8 students' },
};
